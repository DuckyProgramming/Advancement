		...
		for(let a=0,la=level.length;a<la;a++){
			for(let b=0,lb=level[a].length;b<lb;b++){
				if(level[a][b]>=100){
					...
					entities.troops.push(new troop(layer,b*game.tileSize+game.tileSize/2,a*game.tileSize+game.tileSize/2,missions[game.mission].player.type,missions[game.mission].player.primary,missions[game.mission].player.secondary,missions[game.mission].player.passive,missions[game.mission].player.body,missions[game.mission].player.direction,missions[game.mission].player.team,0,missions[game.mission].player.name))
					calc.int[0]=0
					calc.int[1]=0
